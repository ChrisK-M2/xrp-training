...
public class TurnDegreesTank extends Command {
   ...
   *
   * @param speed The speed which the robot will turn (positive is clockwise, negative is counter clockwise). Negative is in reverse.
   * @param degrees Degrees to turn. Leverages encoders to compare distance.
   * @param drive The drive subsystem on which this command will run
   */
  public TurnDegreesTank(double speed, double degrees, Drivetrain drive) {
    m_degrees = degrees;
    m_speed = speed;
    m_drive = drive;
  ...
  // Called every time the scheduler runs while the command is scheduled.
    @Override
  public void execute() {
    m_drive.tankDrive(m_speed,-m_speed);    //This means positive m_speed makes the robot turn clockwise
  }
